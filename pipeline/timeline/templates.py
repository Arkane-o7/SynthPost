...
TEMPLATE_REGISTRY: dict[str, TemplateDefinition] = {
    "meridian_torn_headline": TemplateDefinition(
        template_id="meridian_torn_headline",
        name="Meridian Torn Headline",
        description="A primary-source announcement treated as a single torn paper lead.",
        component="MeridianPrototypeScene.TornHeadline",
        supported_media_types=["image", "document"],
        supported_content_roles=["evidence", "document"],
        anchor_visible=False,
        anchor_speaking=True,
        visual_audio_policy="narration_only",
        required_fields=["scene_assets.primary_source"],
        fallback_template_id="meridian_clipping_board",
        editor_preview_icon="headline",
    ),
    "meridian_evidence_stack": TemplateDefinition(
        template_id="meridian_evidence_stack",
        name="Meridian Evidence Stack",
        description="Primary-source release cards accumulate without resetting the scene.",
        component="MeridianPrototypeScene.EvidenceStack",
        supported_media_types=["image", "document"],
        supported_content_roles=["evidence", "document"],
        anchor_visible=False,
        anchor_speaking=True,
        visual_audio_policy="narration_only",
        required_fields=["scene_assets", "internal_events"],
        fallback_template_id="meridian_clipping_board",
        editor_preview_icon="stack",
    ),
    "meridian_narrator_evidence": TemplateDefinition(
        template_id="meridian_narrator_evidence",
        name="Meridian Narrator + Evidence",
        description="Large narrator reaction beside one restrained editorial note.",
        component="MeridianPrototypeScene.NarratorEvidence",
        supported_media_types=["fallback", "image"],
        supported_content_roles=["explanation", "context"],
        anchor_visible=True,
        anchor_speaking=True,
        visual_audio_policy="narration_only",
        required_fields=["internal_events"],
        fallback_template_id="meridian_presenter_canvas",
        editor_preview_icon="presenter",
    ),
    "meridian_framed_chart": TemplateDefinition(
        template_id="meridian_framed_chart",
        name="Meridian Framed Chart",
        description="An original sourced chart with progressive line and endpoint reveals.",
        component="MeridianPrototypeScene.FramedChart",
        supported_media_types=["chart"],
        supported_content_roles=["data", "evidence"],
        anchor_visible=False,
        anchor_speaking=True,
        visual_audio_policy="narration_only",
        required_fields=["internal_events"],
        fallback_template_id="meridian_data_board",
        editor_preview_icon="chart",
    ),
    "meridian_mechanism": TemplateDefinition(
        template_id="meridian_mechanism",
        name="Meridian Three-Node Mechanism",
        description="A three-step causal mechanism built progressively.",
        component="MeridianPrototypeScene.Mechanism",
        supported_media_types=["fallback"],
        supported_content_roles=["explanation"],
        anchor_visible=False,
        anchor_speaking=True,
        visual_audio_policy="narration_only",
        required_fields=["internal_events"],
        fallback_template_id="meridian_explainer_stage",
        editor_preview_icon="mechanism",
    ),
    "meridian_document_highlight": TemplateDefinition(
        template_id="meridian_document_highlight",
        name="Meridian Document Highlight",
        description="A primary-source document shown in context before a marker highlight.",
        component="MeridianPrototypeScene.DocumentHighlight",
        supported_media_types=["document", "image"],
        supported_content_roles=["document", "evidence"],
        anchor_visible=False,
        anchor_speaking=True,
        visual_audio_policy="narration_only",
        required_fields=["scene_assets.document", "internal_events"],
        fallback_template_id="meridian_document_desk",
        editor_preview_icon="document",
    ),
    "meridian_narrator_tokens": TemplateDefinition(
        template_id="meridian_narrator_tokens",
        name="Meridian Narrator + Tokens",
        description="A large pointing narrator with progressively accumulating company tokens.",
        component="MeridianPrototypeScene.NarratorTokens",
        supported_media_types=["fallback"],
        supported_content_roles=["explanation", "context"],
        anchor_visible=True,
        anchor_speaking=True,
        ...
        required_fields=["internal_events"],
        fallback_template_id="meridian_presenter_canvas",
        editor_preview_icon="tokens",
    ),
    "meridian_footage_montage": TemplateDefinition(
        template_id="meridian_footage_montage",
        name="Meridian Footage Montage",
        description="A short, source-labelled contextual footage sequence.",
        component="MeridianPrototypeScene.FootageMontage",
        supported_media_types=["video"],
        supported_content_roles=["context", "primary_footage"],
        anchor_visible=False,
        anchor_speaking=True,
        visual_audio_policy="muted",
        required_fields=["scene_assets.datacenter", "scene_assets.developer"],
        fallback_template_id="meridian_evidence_reel",
        editor_preview_icon="video",
        validation_rules=["supporting_video_muted_by_default"],
    ),
    "meridian_sparse_thesis": TemplateDefinition(
        template_id="meridian_sparse_thesis",
        name="Meridian Sparse Thesis",
        description="A low-density closing claim with one marker stroke.",
        component="MeridianPrototypeScene.SparseThesis",
        supported_media_types=["fallback"],
        supported_content_roles=["explanation"],
        anchor_visible=False,
        anchor_speaking=True,
        ...
        fallback_template_id="meridian_presenter_canvas",
        editor_preview_icon="thesis",
    ),
    "meridian_evidence_reel": TemplateDefinition(
    ...
    "meridian_document_desk": TemplateDefinition(
        template_id="meridian_document_desk",
        name="Meridian Document Desk",
        description=(
            "A filing, report, or article is treated as a physical document on a "
            "restrained editorial work surface."
        ),
    ...
    "meridian_clipping_board": TemplateDefinition(
        template_id="meridian_clipping_board",
        name="Meridian Clipping Board",
        description=(
            "Evidence is presented as a clipped editorial artifact on graph paper."
        ),
    ...
    "meridian_data_board": TemplateDefinition(
        template_id="meridian_data_board",
        name="Meridian Data Board",
        description=(
            "Charts, maps, and quantitative evidence appear on a tactile analysis board."
        ),
    ...
    "meridian_explainer_stage": TemplateDefinition(
    ...
    "meridian_presenter_canvas": TemplateDefinition(
